...
#SBATCH -J VaxCompare                    # Job name
#SBATCH -o VaxCompare.%j.o               # Name of stdout output file (%j expands to jobId)
#SBATCH -e VaxCompare.%j.e               # Name of stderr output file (%j expands to jobId)
